...
/* JS统一控制
    $('[data-toggle="tooltip"]').jTippy({
        title:'Hey! I\'m a tooltip!',        //内容 date-title=显示内容
        trigger: 'hoverfocus',               //触发 date-trigger=click,focus,hover,hoverfocus
        position: 'auto',                    //定位 data-position=auto,bottom,top,left,right
        class: '',                           //类名 
        theme: 'black',                      //主题 data-theme=black,white,lt-gray,green,red,blue
        size: 'small',                       //大小 data-size=large,medium,small,tiny
...
// 使用标签中的data-*格式设置参数
/*
    date-trigger=click,focus,hover,hoverfocus
    data-position=auto,bottom,top,left,right
    data-theme=black,white,lt-gray,green,red,blue
    data-size=large,medium,small,tiny
    data-backdrop=black,white,blurred,false
*/
