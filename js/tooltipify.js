...
//具体实例：
/*默认参数
    $(".default [title]").tooltipify({		//方法调用，对应模块
		'position': 'top',					//定位：有上下左右四个方位
		'offsetLeft': 0,					//左补偿：增加左侧距离
		...
		'showEvent': 'mouseover',			//显示事件：mouseover、mousemove、contextmenu等
		'hideEvent': 'mouseout',			//同上
		'displayAware': true,				//
		'content': null,					//显示文字：可为null
		'cssClass' : ''						//样式类
	});
*/