...
function array2hex(arr) {
	...
	for (var i = 0; i < arr.length*4; i++) {
		str += hex.charAt((arr[i>>2] >> ((i%4)*8+4)) & 0xf) + hex.charAt((arr[i>>2] >> ((i%4)*8)) & 0xf)
	}
	return str;
}